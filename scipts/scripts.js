...
function scrollFunction(){
    if (document.body.scrollTop > 40 || document.documentElement.scrollTop > 80) {
        ...
        document.getElementById('j-point').style.color="#fff";
...
function animationAdder(){  
    if(document.body.scrollTop > 80 || document.documentElement.scrollTop > 160){
        //Adding animation: 
    let element = document.querySelector('.what-we-do');
    element.classList.add('animate__animated', 'animate__zoomInUp');
    } else if(document.body.scrollTop > 100 || document.documentElement.scrollTop > 200){
    }
}
let elementTwo = document.querySelector('.button-container');
console.log(elementTwo)
elementTwo.classList.add('animate__animated', 'animate__zoomInUp'); 